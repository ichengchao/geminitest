...
public class CommonConstants {
    ...
    public static final String CONFIG_FILE_NAME = "/geminitest.properties";
    ...
    /**
     * 加载顺序:<br>
     * 1. 运行时参数,示例: java -jar -DconfigPath=/home/test/geminitest.properties geminitest.jar <br>
     * 2. geminitest.jar同目录下的geminitest.properties <br>
     * 3. 用户home/config/目录下的geminitest.properties <br>
     * 
     * @return
     */
